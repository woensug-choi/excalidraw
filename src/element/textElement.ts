...
const DEFAULT_LINE_HEIGHT = {
  // ~1.25 is the average for HandWritingFont in WebKit and Blink.
  // Gecko (FF) uses ~1.28.
  [FONT_FAMILY.HandWritingFont]: 1.55 as ExcalidrawTextElement["lineHeight"],
  // ~1.15 is the average for HandWritingFont in WebKit and Blink.
  // Gecko if all over the place.
  [FONT_FAMILY.NormalFont]: 1.75 as ExcalidrawTextElement["lineHeight"],
  // ~1.2 is the average for HandWritingFont in WebKit and Blink, and kinda Gecko too
