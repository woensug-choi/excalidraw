...
| ----------- | ---------------------- |
| `HandWritingFont`    | The `handwritten` font |
| `NormalFont` | The `Normal` Font      |
| `Cascadia`  | The `Code` Font        |

Defaults to `FONT_FAMILY.HandWritingFont` unless passed in `initialData.appState.currentItemFontFamily`.
